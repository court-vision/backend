...
# One game-log model, shared. Two of them, named alike, made the OpenAPI export
# non-deterministic (see migration-free fix in #24); one of them makes the
# question moot, and both endpoints now describe a game the same way.
from .player_games import GameLog
